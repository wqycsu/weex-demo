...
public abstract class AbsWeexActivity extends AppCompatActivity implements IWXRenderListener {
    ...
    private BroadcastReceiver quitAppReceiver = new BroadcastReceiver() {
        @Override
        public void onReceive(Context context, Intent intent) {
            if (intent != null && TextUtils.equals(WXEventModule.QUIT_APP_ACTION, intent.getAction())) {
                AbsWeexActivity.this.finish();
            }
        }
    };
        ...
        WXSDKEngine.setActivityNavBarSetter(new IActivityNavBarSetter() {
            ...
            public boolean setNavBarLeftItem(String param) {
                if (!TextUtils.isEmpty(param)) {
                    ...
                    if (actionBar != null) {
                        if (TextUtils.equals("null", param)) {
                            actionBar.setDisplayHomeAsUpEnabled(false);
                        }
                        if(TextUtils.equals("back", param)) {
            ...
            public boolean setNavBarTitle(String param) {
                Log.d(TAG, "setNavBarTitle: " + param);
                actionBar = getSupportActionBar();
                if (actionBar != null) {
                    actionBar.setTitle(param);
                    return true;
                }
                return false;
            }
    ...
    public void onStart() {
        super.onStart();
        initToolBar();
        LocalBroadcastManager.getInstance(this).registerReceiver(quitAppReceiver,
            new IntentFilter(WXEventModule.QUIT_APP_ACTION));
        if (mInstance != null) {
    ...
    public void unregisterBroadcastReceiver() {
        ...
        LocalBroadcastManager.getInstance(this).unregisterReceiver(quitAppReceiver);
    }
    ...
    public void onBackPressed() {
        ...
        if (comp != null) {
            ...
            data.put("param", "111");
            WXSDKManager.getInstance().fireEvent(mInstance.getInstanceId(), comp.getRef(), "androidback", data, null);
        }
    }
